...
import (
	...
	cfg "github.com/Fincor-Blockchain/pou/config"
	"github.com/Fincor-Blockchain/pou/libs/cli"
	tmflags "github.com/Fincor-Blockchain/pou/libs/cli/flags"
	"github.com/Fincor-Blockchain/pou/libs/log"
	pvm "github.com/Fincor-Blockchain/pou/privval"

	"github.com/Fincor-Blockchain/cusp-sdk/client/flags"
	"github.com/Fincor-Blockchain/cusp-sdk/codec"
	"github.com/Fincor-Blockchain/cusp-sdk/server/config"
	"github.com/Fincor-Blockchain/cusp-sdk/version"
)
...
// If a new config is created, change some of the default pou settings
...
func AddCommands(
	...
	pouCmd := &cobra.Command{
		Use:   "pou",
		Short: "pou subcommands",
	}
...
// UpgradeOldPrivValFile converts old priv_validator.json file (prior to pou 0.28)
