...
import (
	...
	"github.com/Fincor-Blockchain/pou/crypto/merkle"
	cmn "github.com/Fincor-Blockchain/pou/libs/common"
	tmliteErr "github.com/Fincor-Blockchain/pou/lite/errors"
	tmliteProxy "github.com/Fincor-Blockchain/pou/lite/proxy"
	rpcclient "github.com/Fincor-Blockchain/pou/rpc/client"
	tmtypes "github.com/Fincor-Blockchain/pou/types"

	"github.com/Fincor-Blockchain/cusp-sdk/store/rootmulti"
...
// Query performs a query to a pou node with the provided path.
...
// QueryWithData performs a query to a pou node with the provided path
...
// QueryStore performs a query to a pou node with the provided key and
...
// QuerySubspace performs a query to a pou node with the provided
...
// query performs a query to a pou node with the provided store name
...
// queryStore performs a query to a pou node with the provided a store
