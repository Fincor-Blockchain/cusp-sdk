...
// BroadcastTxCommit broadcasts transaction bytes to a pou node and
...
// BroadcastTxSync broadcasts transaction bytes to a pou node
...
// BroadcastTxAsync broadcasts transaction bytes to a pou node
